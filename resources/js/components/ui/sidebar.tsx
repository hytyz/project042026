...
function SidebarProvider({
  ...
  // use openProp/setOpenProp for external control
  ...
  // add state for data-state attribute
  // easier tailwind styling
    ...
    >
      ...
      <div
        className={cn(
          ...
          // adjust padding for floating/inset
          variant === "floating" || variant === "inset"
...
function SidebarMenuSkeleton({
  ...
  // stable width across renders
  // stable style object reference
  const [skeletonStyle] = React.useState(() => (
      {
        "--skeleton-width": `${Math.floor(Math.random() * 40) + 50}%` // random width 50-90%
    } as React.CSSProperties
  ))
